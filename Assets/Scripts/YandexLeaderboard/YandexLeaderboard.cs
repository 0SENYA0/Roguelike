...
namespace Assets.YandexLeaderboard
{
	public class YandexLeaderboard : MonoBehaviour
	{
		...
		[Header("Panels")] [SerializeField] private AuthorizationMessage _authorization;
		...
		{
			GameStatistics playerStat = Game.GameSettings.PlayerData.GameStatistics;
			int playerScore = playerStat.NumberOfAttempts * playerStat.NumberOfEnemiesKilled + playerStat.NumberOfBossesKilled;
