...
namespace Assets.Fight
{
    public class Fight : IDisposable
    {
            ...
            CustomButton customButtonReady)
        {
            ...
            _generatorAttackSteps.GenerateAttackingSteps(_enemyAttackPresenters, _playerAttackPresenter, _unitsOfQueue,
                _countSteps, _stepFightView);
        }
        ...
        private IEnumerator AnimateAttackCoroutine()
        {
            ...
            while (_enemyAttackPresenters.Count > 0 && _playerAttackPresenter.Unit.IsDie == false)
            {
                ...
                {
                    _generatorAttackSteps.GenerateAttackingSteps(_enemyAttackPresenters, _playerAttackPresenter,
                        _unitsOfQueue, _countSteps, _stepFightView);
                    _currentQueueStep = 0;
                    _stepFightView.ActiveFrame(_currentQueueStep);
                }
        ...
        {
            yield return _coroutineRunner.StartCoroutine(StartSingleAnimationCoroutine(AnimationState.Attack,
                unitAttackPresenter));
            ...
            yield return _coroutineRunner.StartCoroutine(StartSingleAnimationCoroutine(AnimationState.Hit,
                _playerAttackPresenter));
        ...
        private IEnumerator UsePlayerAttack()
        {
            ...
            else
            {
                UnitAttackPresenter enemy =
                    _enemyAttackPresenters.FirstOrDefault(x => x.EnemyAttackView.Guid == enemyChooser.AttackView.Guid);
